<aside class="block h-screen max-w-full bg-white p-5 pl-14">
	...
	<div class="mt-10">
		...
		<div class="grid gap-2">
			<a href="/admin" class="block rounded bg-blue-700 py-1 px-3 text-sm text-white">Home</a>
			<a href="/employee" class="block py-1 px-3 text-sm text-gray-600">Employee</a>
